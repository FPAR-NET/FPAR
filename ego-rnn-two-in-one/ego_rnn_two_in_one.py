...
def main_run(version, stage, train_data_dir, stage1_dict, out_dir, seqLen, trainBatchSize,
    ...
    for epoch in range(numEpochs):
        ...
        for i, (inputFrame, inputMMaps, inputFlow, targets) in enumerate(train_loader):
            ...
            if stage == 2:
                ms_loss = loss_ms_fn(F.softmax(ms_lab, dim=1), mmaps_preparation(inputMMaps, 1e-2))
...
def main():
    version = "rgb_16frames_two_in_one_conv1_freeze_3stages_RGB"
    ...
    #stage2Dict = "/content/gdrive/My Drive/FINAL_LOGS/rgb_16frames_regression_kl/model_rgb_state_dict.pth"
    #stage2Dict = "/content/drive/My Drive/FINAL_LOGS/rgb_16frames_classification/model_rgb_state_dict.pth"
    #stage2Dict = "/content/drive/My Drive/FINAL_LOGS/200+150epochs_RGB_16frames/test_2/model_rgb_state_dict.pth"
    #stage2Dict = "/content/drive/My Drive/Lorenzo/ego-rnn-ss-task/results/rgb_16frames_regression_mse_batch16_50100_2/model_rgb_state_dict.pth"
